...
export default function CustomerPortal({ session, user, onLogout }) {
  ...
  const submitRequest = async event => {
    ...
    try {
      ...
      setComment(''); setCounter(''); setDeliveryDate(''); setLineId(''); setNotice('Request sent to the DealFlow team.'); await refresh();
